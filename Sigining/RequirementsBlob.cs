...
{
    class RequirementsBlob
    {
        /*public RequirementsBlob(byte[])
        {
        }*/
        ...
        private static byte[] CreateDefaultRequirementContent(string bundleIdentifier, string certificateFriendlyName)
        {
            ...
            //BinaryPrimitives.WriteUInt32BigEndian(buffer.AsSpan(0, 4), (uint)Operation.True);
        ...
        public static RequirementsBlob CreateDefault(string bundleIdentifier, string certificateFriendlyName)
        {
            ...
            BinaryPrimitives.WriteUInt32BigEndian(blobBuffer.AsSpan(0, 4), (uint)CodeSigningBlobMagic.Requirements);
            ...
            BinaryPrimitives.WriteUInt32BigEndian(blobBuffer.AsSpan(20, 4), (uint)CodeSigningBlobMagic.Requirement);
            ...
            return new RequirementsBlob { content = blobBuffer };
        }
